...
public class UsuariosDAO {
    ...
    public Usuarios buscar(String nomeUsuario) {
        EntityManager em = PersistenceUtil.getEntityManager();
        Query query = em.createQuery("select a from Usuarios a where a.nomeUsuario =:nomeUsuario");
    ...
    public Usuarios login(String nomeUsuario, String emailUsuario) {
        EntityManager em = PersistenceUtil.getEntityManager();
